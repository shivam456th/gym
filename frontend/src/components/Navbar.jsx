  ...
  return (
    ...
    >
      ...
      <div className="flex gap-4">
        ...
        {/* Sign Up Button (Solid Neon) */}
        <button className="rounded-full bg-neon-lime px-6 py-2 font-bold text-dark transition-transform hover:scale-105 hover:bg-neon-lime-hover shadow-[0_0_15px_rgba(198,241,54,0.3)] hover:shadow-[0_0_25px_rgba(198,241,54,0.5)]">
          Sign Up
        </button>
      </div>
    </motion.nav>
